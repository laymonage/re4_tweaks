...
void re4t::init::HandleLimits()
{
	...
	{
		auto pattern = re4t::pattern("68 80 1A 06 00 50 8B 41 ? FF D0 85 C0 0F 85 ? ? ? ? 46");
		...
		pattern = re4t::pattern("68 00 09 3D 00 50 8B 41 ? FF D0 85 C0 0F 85 ? ? ? ? A1 ? ? ? ? 8B 08");
		...
		pattern = re4t::pattern("68 80 84 1E 00 50 8B 41 ? FF D0 85 C0 0F 85 ? ? ? ? A1");
		...
		pattern = re4t::pattern("68 80 8D 5B 00 50 8B 41 ? FF D0 85 C0 0F 85");
		...
		pattern = re4t::pattern("81 80 ? ? ? ? ? ? ? ? A1 ? ? ? ? 8B 90 ? ? ? ? 03 D2");
	...
	if (re4t::cfg->bRaiseInventoryAlloc)
	{
		...
		auto pattern = re4t::pattern("05 ? ? ? ? F6 C1 ? 8B 0D ? ? ? ? A3 ? ? ? ? 8D 91 ? ? ? ? 75 ? 8D 91 ? ? ? ? 52 03 C1");
		...
		pattern = re4t::pattern("68 ? ? ? ? 81 c1 ? ? ? ? 51 50");
		...
		pattern = re4t::pattern("8d 91 ? ? ? ? 75 ? 8d 91 ? ? ? ? 52 03 c1");
		...
		pattern = re4t::pattern("81 c2 ? ? ? ? 52 50 e8 ? ? ? ? 6a");
		...
		pattern = re4t::pattern("8d 94 08 ? ? ? ? 52 53");
		...
		pattern = re4t::pattern("81 c2 ? ? ? ? 89 15 ? ? ? ? 80 b8");
		...
		pattern = re4t::pattern("68 ? ? ? ? 89 35 ? ? ? ? e8 ? ? ? ? 68");
		...
		pattern = re4t::pattern("68 00 00 D0 01");
		...
		pattern = re4t::pattern("8D 8E 00 00 D0 01");
		...
		pattern = re4t::pattern("6A 0D 6A 01 6A 00 6A 00 68 00 AC 34 00");
